...
!insertmacro MUI_LANGUAGEFILE_BEGIN "SimpChinese"
  ...
  !define MUI_INNERTEXT_LICENSE_TOP "许可证协议，敬请阅读："
  !define MUI_INNERTEXT_LICENSE_BOTTOM "必须接受协议才能安装“$(^NameDA)”，否则安装程序将会关闭。"
  ...
  !define MUI_TEXT_FINISH_INFO_TITLE "欢迎使用 “$(^NameDA)” ！"
